@extends('layout-web.master-wanita')
    ...
    <div class="d-flex">
      ...
      <div class="c2 container-fluid mt-4 mb-5 text-center">
        <div class="row justify-content-between">
          ...
          <a href="#" style="text-decoration: none;"><img src="style/asset/img/dress.jpg" class="card-img-top" style="height: 21rem;" alt="...">
            <div class="card-body">
              <p class="card-text text-center" style="color: #313131;">MODEL BATIK KERIS</p>
              <div class="harga01 text-danger">Rp 185.000,00</div>
            </div>
          </a>
          </div>
        </div>
